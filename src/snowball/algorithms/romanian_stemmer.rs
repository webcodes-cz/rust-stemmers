...
static A_0: &'static [Among<Context>; 2] = &[
    Among("\u{015F}", -1, 1, None),
    Among("\u{0163}", -1, 2, None),
];
...
static A_2: &'static [Among<Context>; 16] = &[
    Among("ea", -1, 3, None),
    Among("a\u{021B}ia", -1, 7, None),
    Among("aua", -1, 2, None),
    Among("iua", -1, 4, None),
    Among("a\u{021B}ie", -1, 7, None),
    Among("ele", -1, 3, None),
    Among("ile", -1, 5, None),
    Among("iile", 6, 4, None),
    Among("iei", -1, 4, None),
...
static A_3: &'static [Among<Context>; 46] = &[
    ...
    Among("a\u{021B}iune", -1, 5, None),
    Among("i\u{021B}iune", -1, 6, None),
    ...
    Among("icit\u{0103}\u{021B}i", -1, 4, None),
    Among("abilit\u{0103}\u{021B}i", -1, 1, None),
    Among("ivit\u{0103}\u{021B}i", -1, 3, None),
    Among("ical", -1, 4, None),
    Among("ator", -1, 5, None),
...
static A_4: &'static [Among<Context>; 62] = &[
    ...
    Among("isti", -1, 3, None),
    Among("uti", -1, 1, None),
    Among("i\u{0219}ti", -1, 3, None),
    Among("ivi", -1, 1, None),
    Among("it\u{0103}i", -1, 1, None),
    Among("o\u{0219}i", -1, 1, None),
    Among("it\u{0103}\u{021B}i", -1, 1, None),
    Among("abil", -1, 1, None),
    Among("ibil", -1, 1, None),
    Among("ism", -1, 3, None),
    Among("ator", -1, 1, None),
...
static A_5: &'static [Among<Context>; 94] = &[
    ...
    Among("e\u{0219}te", -1, 1, None),
    Among("\u{0103}\u{0219}te", -1, 1, None),
    Among("eze", -1, 1, None),
    Among("ai", -1, 1, None),
    Among("eai", 19, 1, None),
    Among("iai", 19, 1, None),
    Among("sei", -1, 2, None),
    Among("e\u{0219}ti", -1, 1, None),
    Among("\u{0103}\u{0219}ti", -1, 1, None),
    Among("ui", -1, 1, None),
    Among("ezi", -1, 1, None),
    Among("a\u{0219}i", -1, 1, None),
    Among("se\u{0219}i", -1, 2, None),
    Among("ase\u{0219}i", 28, 1, None),
    Among("sese\u{0219}i", 28, 2, None),
    Among("ise\u{0219}i", 28, 1, None),
    Among("use\u{0219}i", 28, 1, None),
    Among("\u{00E2}se\u{0219}i", 28, 1, None),
    Among("i\u{0219}i", -1, 1, None),
    Among("u\u{0219}i", -1, 1, None),
    Among("\u{00E2}\u{0219}i", -1, 1, None),
    Among("a\u{021B}i", -1, 2, None),
    Among("ea\u{021B}i", 37, 1, None),
    Among("ia\u{021B}i", 37, 1, None),
    Among("e\u{021B}i", -1, 2, None),
    Among("i\u{021B}i", -1, 2, None),
    Among("ar\u{0103}\u{021B}i", -1, 1, None),
    Among("ser\u{0103}\u{021B}i", -1, 2, None),
    Among("aser\u{0103}\u{021B}i", 43, 1, None),
    Among("seser\u{0103}\u{021B}i", 43, 2, None),
    Among("iser\u{0103}\u{021B}i", 43, 1, None),
    Among("user\u{0103}\u{021B}i", 43, 1, None),
    Among("\u{00E2}ser\u{0103}\u{021B}i", 43, 1, None),
    Among("ir\u{0103}\u{021B}i", -1, 1, None),
    Among("ur\u{0103}\u{021B}i", -1, 1, None),
    Among("\u{00E2}r\u{0103}\u{021B}i", -1, 1, None),
    Among("\u{00E2}\u{021B}i", -1, 2, None),
            ...
            'lab2: for _ in 0..1 {
                'golab3: loop {
                    ...
                    'lab4: loop {
                        ...
                        match among_var {
                            1 => {
                                if !env.slice_from("\u{0219}") {
                                    return false;
                                }
                            }
                            2 => {
                                if !env.slice_from("\u{021B}") {
                                    return false;
                                }
                            }
                            _ => (),
